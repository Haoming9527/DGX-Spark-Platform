      ...
      <div className="bg-panel border border-border rounded-xl p-6 space-y-6">
        ...
        {keysLoading || usageLoading ? (
          ...
          <div className="border border-border rounded-xl overflow-hidden divide-y divide-border/30 bg-background/20">
            {/* Table Header */}
            <div className="grid grid-cols-[2fr_1.5fr_1.5fr] gap-4 px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-foreground/30 border-b border-border/30 bg-background/40">
              <span>Key Name</span>
              ...
              {keysWithTimeframeUsage.map((key) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-[2fr_1.5fr_1.5fr] gap-4 items-center px-5 py-3.5 group cursor-pointer hover:bg-white/[0.02] transition-colors"
                  ...
                  >
                    ...
                    <div>
                      <code className="text-xs font-mono text-foreground/50 bg-background border border-border/50 rounded px-2 py-0.5 inline-block">
                        {key.key_prefix}…
                      </code>
                    </div>
